...
func NewDatasetUploadCommand(client client.API, w io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "upload",
		Short: "Upload a file to an AI Task Builder dataset",
		Long: `Upload a CSV file to an AI Task Builder dataset

This command uploads a CSV file to an existing AI Task Builder dataset. The file will be
uploaded to cloud storage and processed for use in batch operations.`,
		Example: `
Upload a file to an AI Task Builder dataset:
$ prolific aitaskbuilder dataset upload -d 01996422-2196-7590-a0d9-a4143a547704 -f docs/examples/aitb-model-evaluation.csv
		`,
